function [sMap,A,V] = modifiedsom_lininitcrank_exp2(D, varargin)
...
V=[-0.00277440734870266	0.204467811985981;
0.9*-0.0466401709911600	0.9*0.196007892813735;
0.75*-0.255844956728006	0.75*-0.0672288783898046;
1.2*-0.0405413199613141	1.2*-0.111199722374478;
1.2*-0.128392244510364	1.2*0.0329131039091460;
-0.227382134349584	0.0341867099974490];
