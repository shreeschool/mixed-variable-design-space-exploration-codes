setwd("D:/IIT Madras/Gifi methods/Final Unconstrained problems/Goldstein from lit")
# D:/IIT Madras/Gifi methods/Final Unconstrained problems/Rosenbrock 2D
library(readxl)
data=read_excel('goldstein_exp1.xlsx')
...
library("writexl")
write_xlsx(data.frame(princals_mixed_iris[["scoremat"]]),"D:/IIT Madras/Gifi methods/Final Unconstrained problems/Goldstein from lit/conversion_gold.xlsx")